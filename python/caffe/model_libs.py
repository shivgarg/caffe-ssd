...
def CreateAnnotatedDataLayer(source, batch_size=32, backend=P.Data.LMDB,output_label=True, 
                per_image_label=False, image_label_loss=0, train=True, label_map_file='', anno_type=None,
